...
var (
	reflectSliceIntType     = reflect.TypeOf([]int{})
	reflectSliceInt8Type    = reflect.TypeOf([]int8{})
	reflectSliceInt16Type   = reflect.TypeOf([]int16{})
	reflectSliceInt32Type   = reflect.TypeOf([]int32{})
	reflectSliceInt64Type   = reflect.TypeOf([]int64{})
	reflectSliceFloat32Type = reflect.TypeOf([]float32{})
	reflectSliceFloat64Type = reflect.TypeOf([]float64{})
)

type (
	TagDecoder interface {
		Decode(interface{}) interface{}
	}

	TagDecoderImpl struct {
		tagName string
	}
)

func New(tagName string) *TagDecoderImpl {
	return &TagDecoderImpl{tagName}
}

func (tagDecoder *TagDecoderImpl) Decode(in interface{}) interface{} {
	...
	parse = func(in interface{}) reflect.Value {
		...
		case reflect.Ptr:
			...
			return parse(r.Elem().Interface())
		default:
			return v
		}
	}
	return parse(in).Interface()
